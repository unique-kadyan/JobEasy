                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="mb-1 flex flex-wrap items-center gap-2">
                      <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-indigo-50 dark:bg-indigo-600/10">
                      ...
                      {t.isSystem && (
                        <Badge className="bg-indigo-50 text-[10px] text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400">
                          System
                        </Badge>
                      )}
                    </div>
                    {t.description && (
                      <p className="ml-9 text-xs text-[#86868b] dark:text-[#8e8e93]">
                        {t.description}
                      </p>
                    )}
                    <p className="mt-2 ml-9 line-clamp-2 text-xs text-[#86868b] dark:text-[#8e8e93]">
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              className="block w-full rounded-xl border border-black/10 bg-white px-3 py-2 text-sm text-[#1d1d1f] transition-shadow placeholder:text-[#86868b] focus:ring-2 focus:ring-indigo-500/20 focus:outline-none dark:border-white/10 dark:bg-[#1c1c1e] dark:text-white dark:placeholder:text-[#636366]"
              rows={8}
              value={content}
