...
// Covers findByUserIdOrderByCreatedAtDesc — filter on userId, sort on createdAt in one seek
...
public class Resume {
    ...
    public static final class Builder {
        ...
        public Builder parsedText(String parsedText) {
            this.parsedText = parsedText;
            return this;
        }

        public Builder parsedData(Map<String, Object> parsedData) {
            this.parsedData = parsedData;
            return this;
        }
