...
public class ResumeProfile {
    ...
    public ContactTag getContact() { return contact; }
    public String getHeadline() { return headline; }
    public String getSummary() { return summary; }
    public Double getYearsOfExperience() { return yearsOfExperience; }
    public String getExperienceLevel() { return experienceLevel; }
    public List<ExperienceTag> getExperience() { return experience; }
    public List<EducationTag> getEducation() { return education; }
    public Map<String, List<String>> getSkills() { return skills; }
    public List<ProjectTag> getProjects() { return projects; }
    public List<CertificationTag> getCertifications() { return certifications; }
    public List<String> getTargetRoles() { return targetRoles; }
    public List<String> getSkipKeywords() { return skipKeywords; }
    public PreferencesTag getPreferences() { return preferences; }
    public Map<String, Object> getCustomTags() { return customTags; }
    ...
    public void setContact(ContactTag contact) { this.contact = contact; }
    ...
    public void setExperience(List<ExperienceTag> experience) { this.experience = experience; }
    public void setEducation(List<EducationTag> education) { this.education = education; }
    public void setSkills(Map<String, List<String>> skills) { this.skills = skills; }
    public void setProjects(List<ProjectTag> projects) { this.projects = projects; }
    public void setCertifications(List<CertificationTag> certifications) { this.certifications = certifications; }
    ...
    public void setPreferences(PreferencesTag preferences) { this.preferences = preferences; }
    public void setCustomTags(Map<String, Object> customTags) { this.customTags = customTags; }
}
